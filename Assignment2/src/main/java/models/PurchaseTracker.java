...
public class PurchaseTracker {
    ...
    public double calculateTotalVolume() {
        // TODO use OrderedList.aggregate to calculate the total number of products purchased
    ...
    public double calculateTotalRevenue() {
        // TODO use OrderedList.aggregate to calculate the total revenue from all purchases
